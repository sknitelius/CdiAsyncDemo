...
public class HelloBoundary {
  ...
  public Response sayHello(@QueryParam("name") String name) throws InterruptedException, ExecutionException {
    Future<String> helloFuture = asyncCDIBean.hello(name);
    String msg = "Response by: " + Thread.currentThread().getName() + " Msg: " + helloFuture.get();
